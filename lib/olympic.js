...
exports.getAverageAge = exports.getGenderCountPerDecade = exports.getCountriesWonMedal = exports.getNoOfOlympicHosted = void 0;
...
const getAverageAge = athlete_events => {
  var sAge = 0,
      wAge = 0,
      wTotal = 0,
      sTotal = 0; // console.log(getBoxingEvents(athlete_events,'Event','Age'));
