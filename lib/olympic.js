...
exports.getMedalistsIndia = exports.getAverageAge = exports.getGenderCountPerDecade = exports.getNoOfOlympicHosted = void 0;
...
function getCountriesWonMedal(athlete_events, noc_regions) {
  ...
  Object.keys(result).sort((a, b) => {
    result[b]['medal_count'] - result[a]['medal_count'];
  }).slice(0, 10).map(e => {
...
const getAverageAge = athlete_events => {
  ...
  return Object.keys(avg_age).reduce((result, item) => {
    result[item] = avg_age[item]['avg_age']; //  result[item]['avg_age'] = avg_age[item]['avg_age'];
