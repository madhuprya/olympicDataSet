...
let athleteEvents = require("../input/athleteEvents.json");
...
function mostMedalsWonByCountries(athleteEvents, nocRegions) {
    ...
    let topTenCountriesToWinTheMostMedals = Object.keys(medalsWonByCountry)
...
console.log(mostMedalsWonByCountries(athleteEvents, nocRegions))
